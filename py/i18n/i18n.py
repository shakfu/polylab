...
LOCALE_DIR = os.path.join(APP_DIR, 'i18n', 'locale')
...
def translate(s):
    return language.ugettext(s).encode('utf8')


def translate_decode(s):
    return language.ugettext(s).encode('utf8').decode('utf8')
