 ...
 * @file root-tree.h
 *
 * @brief Rooted Ordered Tree.
 *
 * This data structure defines a rooted, ordered, tree with pointers
 * to both child and parent nodes. Accessors are also provided for
 * easy determination of the sibling nodes, both to the left and the
