...
extern int main(void)
{
    ...
    pthread_create(&thread1, NULL, add_while_full, (void*)&thread1_id);
    printf("main: creating second adding thread\n");
    pthread_create(&thread2, NULL, add_while_full, (void*)&thread2_id);
