...
void Object_dance(Object* obj) { obj->vtable->dance(obj); }
...
Vtable Person_vtable = {
    (void*)&Person_dance, /* you might get a warning here about incompatible
                             pointer types */
    (void*)&Person_jump   /* you can ignore it, or perform a cast to get rid of
                             it */
};
