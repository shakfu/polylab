...
int main(int argc, char* argv[])
{
     ...
     * "test-menu". Notice the call to gtk_menu_shell_append.  Here we are
     * adding a list of menu items to our menu.  Normally, we'd also catch the
     * "clicked" signal on each of the menu items and setup a callback for it,
