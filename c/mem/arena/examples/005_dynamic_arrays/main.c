...
// String Builder is any structure that has at least three fields: items,
// count, and capacity.
// - `items` MUST be a pointer to char and it points to the beginning of the
// buffer that stores the string.
// - `count` MUST be size_t and it indicates the size of the string.
// - `capacity` MUST be size_t and it indicates how much memory was already
// allocated for the String Builder. String Builder in a sense is just a
