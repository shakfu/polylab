-------------------------------------------------------------------------------
-- This module is written by Dmitry Antonyuk (lomeo@mail.ru)
-- based on Martin Porter's Stemming algorithm 
-- see: (http://tartarus.org/~martin/PorterStemmer) for the original version
-- which has been slightly modified in this instance after a run of hlint.
-- All rights, of course, are reserved for the original author, Dmitry Antonyuk
-------------------------------------------------------------------------------
...
step4 word = fromMaybe word result
    where
        ...
        result       = findGT1 ["al", "ance", "ence", "er", "ic", "able", "ible", "ant", "ement", "ment", "ent"]
                        `mplus` findStem gt1andST word [("ion","")]
                        `mplus` findGT1 ["ou", "ism", "ate", "iti", "ous", "ive", "ize"]
