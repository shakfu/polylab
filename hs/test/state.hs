...
-- function to be given to modify
transform :: (String, Int) -> (String, Int)
transform (x, y) = (x ++ "HELLO", y + 100)
...
update_best_with (current_name, current_count) = do 
    ...
    modify transform -- applies a function to the state
