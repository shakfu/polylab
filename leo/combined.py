...
class LeoObject(object):    
    ...
    def template(self, txt, **kwds):
        template = string.Template(txt)
        return template.subsitute(**kwds)
...
def test(verbose=False):
    ...
    for i, body in enumerate(bodies):
        ...
        print 'root.body.type:', root.body.type
        print 'root.body.code:', root.body.code
        print 'root.body.data:', root.body.data
        print 'root.body.view:', root.body.view

        print 'root.head.type:', root.head.type        
        print 'root.head.code:', root.head.code
        print 'root.head.data:', root.head.data
        print 'root.head.view:', root.head.view
